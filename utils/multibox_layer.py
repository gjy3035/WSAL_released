...
class MultiBoxLayer(nn.Module):
    ...
    # num_anchors = [2,3,3,3,2,2]
    in_planes = []
    if cfg.TRAIN.NET == 'vgg': 
        in_planes = [512,1024,512,256,256,256]
    elif cfg.TRAIN.NET == 'res': 
        in_planes = [512,1024,512,256,256,256]
    ...
    def __init__(self):
        ...
        for i in range(len(self.in_planes)):
        	...
        	self.conf_layers.append(nn.Conv2d(self.in_planes[i], self.num_anchors[i]*20, kernel_size=3, padding=1))
    ...
    def forward(self, xs):
        ...
        Returns:
          ...
          conf_preds: (tensor) predicted class confidences, sized [N,8732,20].
        '''
        y_locs = []
        y_confs = []
